...
/**
 * Tests multiple request with different redirect uri parameters with {@link io.undertow.UndertowOptions#DECODE_URL} enabled.
 *
 * @author Flavia Rainone
 */
@RunWith(DefaultServer.class)
public class RedirectURIWithDecodeURLTestCase extends AbstractRedirectURITest {
