...
/**
 * Tests multiple request with different redirect uri parameters with {@link
 * io.undertow.UndertowOptions#ALLOW_UNESCAPED_CHARACTERS_IN_URL allow unescaped characters config } enabled.
 *
 * @author Flavia Rainone
 */
@RunWith(DefaultServer.class)
public class RedirectURIWithAllowUnescapedCharactersTestCase extends AbstractRedirectURITest {
